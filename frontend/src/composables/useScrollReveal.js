...
export function useScrollReveal() {
  const setupScrollReveal = () => {
    onMounted(() => {
      ...
      // Animaciones hacia arriba para servicios
      ...
      // Animaciones hacia arriba escalonadas
      ScrollReveal().reveal(".reveal-up-1", {
        origin: "bottom",
        distance: "50px",
        duration: 600,
        delay: 100,
      ...
      ScrollReveal().reveal(".reveal-up-3", {
        origin: "bottom",
        distance: "50px",
        duration: 600,
        delay: 300,
      ...
      ScrollReveal().reveal(".reveal-up-4", {
        origin: "bottom",
        distance: "50px",
        duration: 600,
        delay: 400,
      ...
      ScrollReveal().reveal(".reveal-up-5", {
        origin: "bottom",
        distance: "50px",
        duration: 600,
        delay: 500,
      ...
      ScrollReveal().reveal(".reveal-up-6", {
        origin: "bottom",
        distance: "50px",
        duration: 600,
        delay: 600,
